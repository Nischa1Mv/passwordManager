...
const Copied = (text) => {
  return (
    <>
      <div className="absolute text-black border top-6 ">copied!</div>
    </>
  );
};
const Data = () => {
  ...
  return (
    <>
      <div className="border-2 border-[#1c201e]">
        ...
        <div className="flex  ">
          <div className="flex gap-2   ">
            ...
            <div>
              <input
                className="border-2 border-[#1c201e] relative bg-transparent focus:outline-none"
                type="email"
                value={email}
                readOnly
              />
